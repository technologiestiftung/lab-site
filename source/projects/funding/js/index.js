...
var Chart = (function(window, d3) {
        ...
        moneyRelative: [
            {
                ...
                content: [
                    '2011 fließt der größte Anteil',
                    'aller Förderungen des Jahres',
                    'mit mehr als 25% in',
        ...
        countRelative: [
            {
                ...
                content: [
                    'Im Sektor Arbeit werden',
                    'vergleichsweise viele',
                    'Projekte gefördert. Die Anzahl',
                    'sinkt tendenziell. Dafür werden',
                    'größere Summen gefördert.'
                ]
            },
        ],
        countAbsolute: [

            {
                ...
                content: [
                    '2016 wurde die erste Förderung',
                    'im Bereich Tierschutz bewilligt.'
                ]
            }
        ]
    }
    ...
    var legendTitle = {
        moneyAbsolute: 'Kreisfläche: Volumen aller Zuwendungen in Euro',
        moneyRelative: 'Kreisfläche: Volumen in % pro Jahr',
        countRelative: 'Kreisfläche: Anzahl in % pro Jahr',
        countAbsolute: 'Kreisfläche: Anzahl d. Zuwendungen pro Jahr.'
    }
    ...
    function renderLegend(view) {
        ...
        const proj_div = document.querySelector('.project-text');
        console.log(proj_div.getBoundingClientRect());
