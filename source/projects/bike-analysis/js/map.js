//TODO: [IPLSITE-14] Map is broken in projects/bike-analysis/
class Map {
  constructor(config) {
    this.div = config.div;
  ...
  init() {
    //add map
    var map = L.map(this.div, { zoomControl: false }).setView(
      [52.51, 13.39],
      12,
    );
    ...
    L.tileLayer(
      "https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token={accessToken}",
      {
        ...
        id: "mapbox.light",
        accessToken:
          "pk.eyJ1IjoibHhuZHJrcCIsImEiOiJjanRoZDBlaGgwdGh4NDNydWhwbHo4ZXdsIn0.iCdQLK7JUYDX-JuNwzZnsw",
      },
    ).addTo(map);
    ...
    if (this.scaleMax) {
      ...
      var max = d3.max(this.file.features, function (d) {
