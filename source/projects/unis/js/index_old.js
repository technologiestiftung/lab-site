var map_chart, bee_chart, tool_tip, table_ranking, brushed_tool_tip, brushed_tool_tip_berlin, map_chart_berlin, map_chart_berlin_legend, bee_chart_berlin, berlinStudents, berlinStudies, berlinAge,
rankedByAge, rankedByStudents, brush_extent, rankedByStudies, filterDefault, filterSwitch = 'students', order = 'ascending', unis_berlin, typeGlobal, zoomTimer = 3;
...
const mapChart = function (_data, _geojson, _filterFunction, _filterKey, _container, _proj, _type) {
    ...
    var pointer = overlay.append('img')
        .attr('src', '../images/zoom.png')
        .attr('width', 54)
        .attr('height', 54)

    var hint = overlay.append('span')
        .attr('class', 'hint')
...
d3.queue()
    ...
    .await( (error, unis, germany, berlin) => {
        ...
        var _public = unis_berlin.filter(uni => uni.sponsor == 'öffentlich-rechtlich');
        ...
        _public.forEach(uni => { countPublic += uni.count_students })
