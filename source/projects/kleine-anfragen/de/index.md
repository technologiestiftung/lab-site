...
subtitle: "Für welche Daten interessiert sich Berlin?"
type: publication
colorMode: bright
...
Die Berliner Verwaltung öffnet Schritt für Schritt ihre Daten und stellt diese über das [Open Data Portal](https://daten.berlin.de) bereit. Es stellt sich immer wieder die Frage, wie durch das Öffnen von Daten reale Mehrwerte für Verwaltungen und Bürger\*innen entstehen können. [Hier](https://lab.technologiestiftung-berlin.de/projects/od-for-cities/index.html) haben wir bereits über das Potenzial und mögliche Anwendungsfälle von Open Data berichtet. Um weiter der Frage auf den Grund zu gehen, **welche Datensätze interessant und relevant sind**, haben wir in diesem Projekt einen weiteren Ansatz ausprobiert: **Die Analyse von _kleinen Anfragen._**
...
Durch _kleine Anfragen_ haben Abgeordnete die Möglichkeit Informationen bei der Regierung und Verwaltung anzufordern. Innerhalb von fünf Wochen muss eine Anfrage beantwortet werden. Die Anfragen mit den Antworten der Senatsverwaltungen werden auf der Plattform [Kleine Anfragen](https://kleineanfragen.de/) gesammelt und zum Download bereitgestellt. Damit eröffnet sich ein riesiger Fundus an Informationen zu:  
...
Laut einer [amerikanische Studie](http://sunlightfoundation.com/wp-content/uploads/2018/10/alena-white-paper-PDF.pdf) lassen sich Anfragen signifikant durch die Bereitstellung offener Daten reduzieren. Somit ist Open Data nicht nur ein Transparenz-Gewinn für Bürger\*innen und Abgeordnete, sondern verringert auch potenziell die Anzahl an Anfragen für Verwaltungsmitarbeiter\*innen.  
Wir haben die Berliner Anfragen analysiert, um herauszufinden welche Themen für Berlin besonders interessant sind und welches Potenzial für Open Data in den Anfragen steckt.
...
Die großen Themen der Landespolitik Bildung (Schule) und Polizei zeigen sich in den zwei mit Abstand häufigsten Begriffen: _Schule (580 Anfragen)_ und _Polizei (446 Anfragen)_. Aktuelle politische und mediale Geschehen in Berlin spiegelt sich ebenfalls in den Themen der Anfragen wider: Wohnungen, öffentlicher Nahverkehr, die Flughäfen (BER, Tempelhof und Tegel) und Flüchtlinge gehören zu den weiteren größten Themenkomplexen.  
  

### Bildung und Kinderbetreuung

Die meisten Anfragen werden rund um das Thema Bildung und Schule gestellt. Verwendete Begriffe sind hier beispielsweise "Schule" (580 Anfragen), "Bildung" (75), "Hochschule" (122), "Lehrkräfte" (44) und "Willkommensklassen" (37), sowie "Kinder" (200), "Kitas" / "Kitaplätze" (150) und "Jugend" (98).  
Welche Daten sind zu diesem Thema bereits offen verfügbar? Berlin bietet [detaillierte Informationen zu Standorten und Angeboten von Schulen](https://www.berlin.de/sen/bildung/schule/berliner-schulen/schulverzeichnis/), die in einer [Anwendung der OKNF](https://jedeschule.de/) visuell schön aufbereitet sind. Die Senatsverwaltung für Bildung, Jugend und Familie stellt zusätzlich Statistiken über die [Anzahl Schüler\*innen nach Schulart und Region](https://www.bildungsstatistik.berlin.de/visualisierung/Schueler/schueler.aspx) sowie schöne Visualisierungen der [Bewegungen zwischen Wohnbezirk und Schulbezirk](https://www.bildungsstatistik.berlin.de/visualisierung/circle/index.html) bereit.  
Jedoch gibt es noch einges an Potenzial um Datensätze als Open Data bereitzustellen. So hat die SPD beispielsweise [134 Anfragen zum "Sonderungsverbot"](http://pardok.parlament-berlin.de/starweb/adis/citat/VT/18/SchrAnfr/s18-16220.pdf) privater Schulen gestellt. Weitere Anfragen, die potenzielle Open Data Datensätze enthalten sind beispielsweise:
...
*   [Bedarf Erzieherpersonal](http://pardok.parlament-berlin.de/starweb/adis/citat/VT/18/SchrAnfr/s18-15296.pdf)
*   [Lehrkraft-Quereinsteigende](https://kleineanfragen.de/berlin/18/17293-lehrkraefte-quereinsteigende-in-den-berliner-schulen-im-schuljahr-2018-2019) - dieser Datensatz wurde beispielsweise [in diesem Projekt für eine Visualisierung verwendet](http://www.tursics.de/story/quereinsteigende/)

### Polizei und Kriminalität

"Polizei" ist der zweithäufigste Begriff in den Anfragetiteln. Das Thema ist parteiunabhängig relevant. So hat beispielsweise die SPD [detaillierte Zahlen zu jeder Direktion der Polizei](https://kleineanfragen.de/search?q=controlling+ist+gut+kontrolle+ist+besser) angefragt. Die CDU hat viele Anfragen zu [Planstellen vs. tatsächliche Beschäftigte](https://kleineanfragen.de/search?q=Planstellen+tats%C3%A4chliche+Besch%C3%A4ftigte+polizei) gestellt und die FDP zu [Arbeitsschutz und Gesundheitsförderung der Polizei](https://kleineanfragen.de/search?q=arbeitsschutz+gesundheitsf%C3%B6rderung+polizei). Weitere häufige Begriffe sind "Feuerwehr" (166), "organisierter Kriminalität" (71), "Rockerkriminalität" (51), "Justizvollzug" (31) und zum Anschlag am Breitscheidplatz vom 19. Dezember 2016 wurden 94 Anfragen gestellt. Letztes Jahr wurde mit dem [Kriminalitätsatlas](https://daten.berlin.de/anwendungen/kriminalit%C3%A4tsatlas-app) bereits ein wichtiger Datensatz als Open Data bereitgestellt _[(Hier haben wir dazu berichtet)](https://lab.technologiestiftung-berlin.de/projects/crime-atlas/index.html)_. Potenzial für weitere Open Data Datensätze zum Thema Polizei verbergen sich beispielsweise hinter diesen Anfragen:
...
Zum Thema "Wohnen" wurden 2018 so viele Anfragen gestellt wie in keinem Jahr zuvor. Der Teilbegriff "wohn" kommt 731 in den Titeln vor, versteckt hinter verschiedenen Begriffen z.B. Wohnung, Wohnungsbaugesellschaften, Wohnraum, Wohnungsnot, etc. Weitere Begriffe zu dem Thema sind "Immobilien" (67), "landeseigenen Wohnungsbaugesellschaften" (61), "Neubauvorhaben" (33), "An- und Verkäufe" (59). Mögliche interessante Datensätze in Anfragen sind beispielsweise:
...
Die **Senatsverwaltung für Inneres & Sport** hat in beiden Wahlperioden mit die meisten Anfragen erhalten. Dabei handelte es sich vor allem um Themen zu Polizei, Feuerwehr, Kriminalität und Badebetrieben.
...
Potenzial für Open Data
-----------------------

Was bedeutet dies konkret für Open Data? Nicht alle Anfragen beziehen sich auf Datensätze. Aber immerhin ca. ein Drittel der über 15.000 Anfragen beinhalten Tabellen, was ein Hinweis auf enthaltene Daten sein kann. Zusätzlich werden in den Anfragen häufig aggregierte Zahlen und Statistiken herausgegeben, die auf interessante zugrundeliegende Rohdaten hinweisen: Beispielsweise wird in [dieser Anfrage](http://pardok.parlament-berlin.de/starweb/adis/citat/VT/18/SchrAnfr/s18-10513.pdf) darauf hingewiesen, dass es regelmäßige statistische Erhebungen zum Schulschwimmen gibt, aus denen eine Nichtschwimmerquote von 18.2% hervorgeht. Diese statistischen Erhebungen aufgeschlüsselt nach Bezirken, Schulen oder Klassenstufen könnten beispielsweise ein interessanter Datensatz sein.  
  
Grundsätzlich wäre ein erster hilfreicher Schritt, wenn in den Anfragen enthaltene Datensätze zusätzlich zum pdf Dokument in **maschinenlesbarer Form veröffentlicht** werden würden (beispielsweise als CSV oder Excel Datei). Dadurch sind sie leichter weiterzuverwenden, leichter durchsuchbar und auffindbar. Zusätzlich empfehlen wir, festzustellen ob eine **grundsätzliche Bereitstellung der angefragten Daten als Open Data** sinnvoll und möglich ist. Dies hätte nicht nur den Vorteil des leichten Zugriffs für Bürger\*innen und Abgeordnete, sondern es könnte potenziell zu weniger Anfragen für Verwaltungsmitarbeiter\*innen führen.

Einschränkungen der Analyse
---------------------------

Bei der Interpretation dieser Ergebnisse ist zu bedenken, dass sich nicht alle Anfragen auf Datensätze beziehen. Somit lassen sich die Häufigkeiten der Begriffe nicht direkt auf sinnvolle Bereiche für Open Data Datensätze übersetzen. Außerdem ist zu berücksichtigen, dass Daten nicht mehr angefragt werden müssen, wenn diese bereits verfügbar sind. Somit lässt sich ebenfalls keine eins-zu-eins Übertragung von Begriffshäufigkeiten auf Relevanz von Themen vornehmen.  
Die Analyse über die Titel lässt eine grobe Übersicht der Themen zu, ist jedoch keine vollständig akkurate Auswertung: die Titel sind sind von den Abgeordneten frei wählbar und folgen keinem bestimmten Format. Somit sind nicht zwangsläufig alle enthaltenen Themen der Anfrage aus dem Titel ersichtlich. Eine Analyse der Volltexte wäre komplexer und umfangreicher würde aber gegebenenfalls detailliertere Informationen ermöglichen. Zusätzlich ist bei dieser Textanalyse zu bedenken: Synonyme werden nicht berücksichtigt, zusammengesetzte Worte werden nicht immer gut getrennt durch das verwendete Analyse-Package (bspw. wird Wohnungsnot nicht dem Wort 'Wohn' zugeordnet) und doppelte Wortbedeutungen werden nicht beachtet (z.B. Behinderung kann sich auf Behinderung des Straßenverkehrs oder körperliche Behinderung beziehen).
