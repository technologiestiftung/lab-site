...
**Doch wie sieht diese Kontrolle aus?** Die mühsame manuelle Arbeit von Ordnungsamtmitarbeiter\*innen ließe sich einfach **automatisieren**, wenn die Standortdaten der Fahrzeuge dem Ordnungsamt in Echtzeit und digital zur Verfügung gestellt werden würden. In anderen Städten wird dieses Potenzial genutzt, beispielsweise Los Angeles (USA), wo mit der Mobility Data Specification (MDS) verpflichtende Standards für Anbieter vorgeben werden:
...
Grundsätzlich lässt sich sagen: Jeder Anbieter stellt die Fahrraddaten anders bereit. Das heißt im Umkehrschluss, dass man sich für jeden Anbieter einzeln die API anschauen und abwandeln muss, um sie in einer gesamten Darstellung oder Analyse zu verarbeiten. Allein das ist erstmal ein zeitlicher Mehraufwand.
...
Das Gebiet, für das man die Daten erhält ist nicht vollständig ersichtlich, das es nicht 100% mit dem gesetzten Parameter der Bounding Box oder der User Latitude / Longitude übereinstimmt. Pro Anfrage erhält man maximal Informationen zu 50 Fahrrädern.
...
Es können Apps bereitgestellt werden, die alle Anbieter auf einmal anzeigen und eine Echtzeitrückmeldung der vollständigen Mobilitätssituation ermöglichen.
