...
## Anmerkung zu der politischen Bedeutung von Wahlbezirken

Eine Änderung einer Bezirksgrenze ist immer ein heikles Thema und erweckt Skepsis hinsichtlich der Neutralität des Verfassers auf – Beobachter der US-Politik werden schon mit Diskussionen von [Gerrymandering](https://en.wikipedia.org/wiki/Gerrymandering) und wie es Wahlergebnisse beeinflussen kann vertraut. Mit unserem Wahlbezirkprototyp haben wir bewusst ein Tool entwickelt, das **politisch neutrale Unterstützung** beim Zuschnitt von neuen Wawhlbezirke anzubietet. Unser Tool entscheidet nicht darüber, wie die neuen Wahlgebiete aussehen sollen, sondern schlägt eine Reihe von Szenarien vor, die von den Benutzer*innen weiter nach ihrem individuellen Wünschen bearbeitet werden können. Dieses Tool ist ein Hilfsmittel, nicht eine komplette Lösung, und ist nicht dafür gedacht, menschliche Entscheidungsprozesse zu ersetzen.

Unser Algorithmus verwendet offizielle Verwaltungsdaten, um Iterationen zu generieren, die sowohl die geografische Kompaktheit der Wahlbezirke als auch die Gleichmäßigkeit der Bevölkerungsverteilung im Bezirk maximieren. Dabei werden weder demografische Merkmale noch Daten zur politischen Zugehörigkeit berücksichtigt. Unser Instrument ist daher nicht in der Lage, eine politische Partei oder eine demografische Gruppe systematisch zu bevorzugen, sondern versucht, eine Vielzahl von Szenarien anzubieten, die ausschließlich auf der Verteilung der Bevölkerung innerhalb des Bezirks basieren. Entsprechend unserer Verpflichtung zur Transparenz und Neutralität dieses Prozesses steht unser Code für Replikationszwecke [offen auf GitHub zur Verfügung](https://github.com/technologiestiftung/odis-wahlbezirke).
