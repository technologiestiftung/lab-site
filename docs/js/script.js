...
if (d3.selectAll('.gallery li').size() >= 1) {
    d3.selectAll('.gallery li')
        .classed('two-break', function(d, i) {
            return i % 2 == 0 ? true : false;
        })
        .classed('three-break', function(d, i) {
...
d3.selectAll('a.lghtbx').on('click', function() {
    d3.event.preventDefault();
    ...
    function loadImage() {
        ...
        loader.onload = function() {
            ...
            if (titles[i].length > 0) {
                subline.text(titles[i]).style('display', 'block');
            }
        };
